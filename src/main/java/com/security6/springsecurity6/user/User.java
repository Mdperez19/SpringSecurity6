...
@AllArgsConstructor
@Entity
@Table(name = "_user") //otra tabla llamada _user
public class User implements UserDetails { // UserDetails es una interfaz de Spring Security, se puede usar la implementation de Spring Security
